...
export class ContactService  {
  ...
  // tslint:disable-next-line: variable-name
  private _contacts$ = new BehaviorSubject<Array<Contact>>(this._contacts);
  ...
  public loadContacts(filterBy = null): void {
    let contacts = this.storageService.load(this.key)
    !contacts ? contacts = this._contacts : this._contacts = contacts;
  ...
  public deleteContact(id: string) {
    ...
    this.storageService.save(this.key,this._contacts)
